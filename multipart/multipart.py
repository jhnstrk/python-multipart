...
def join_bytes(b: bytes | list[int]) -> bytes:
    return bytes(list(b))
...
class MultipartParser(BaseParser):
    ...
    def _internal_write(self, data: bytes, length: int) -> int:
        ...
        def data_callback(name: CALLBACK_NAMES, remaining: bool = False) -> None:
...
def parse_form(
    ...
    while True:
        ...
        max_readable = int(min(content_length - bytes_read, 1048576))
